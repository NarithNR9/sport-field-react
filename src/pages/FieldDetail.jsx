...
const FieldDetail = () => {
  ...
  useEffect(() => {
    dispatch(getBlacklists(fieldId));
  }, []);
  ...
  if (isLoading) {
    ...
    return (
      <div className="">
                ...
                <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    <FaStar
                      ...
                      data-bs-target={
                        player && !isBanned && "#exampleModalCenter"
                      }
                    />
        ...
        {isBanned ? (
          <div className="flex flex-col justify-center items-center m-4 text-lg md:text-2xl text-red-600">
            <p>Sorry you have been banned from booking this field!</p>
            <p>
              Reason: <b>{reason}</b>
            </p>
          </div>
